export const helpRegistry = {
  ...
  build: [
    ...
    { usage: 'lm build server', description: '拉取并构建 server 项目' },
  ...
  check: [
    ...
    { usage: 'lm check server', description: '检查 server 项目' },
    { usage: 'lm check web', description: '检查 web 项目' },
    { usage: 'lm check admin', description: '检查 admin 项目' },
